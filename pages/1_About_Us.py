...
st.markdown("<h4 style='text-align: center; color: gray;'>Not sure what to believe? Drop it here and let’s check the facts and verify it here!</h4>", unsafe_allow_html=True)
